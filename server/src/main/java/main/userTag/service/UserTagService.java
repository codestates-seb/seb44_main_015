...
public class UserTagService {
    ...
    private void verifyExistUserTag(Long userId, String tagName){
        Optional<UserTag> optionalUserTag = userTagRepository.findByUserUserIdAndTagName(userId,tagName);
